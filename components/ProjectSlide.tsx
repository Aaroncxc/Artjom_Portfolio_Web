      ...
      <div className="snap-section flex flex-col justify-center px-4 sm:px-6 py-6 sm:py-8 lg:py-16 min-h-[100dvh]">
        <div className="max-w-5xl w-full mx-auto">
          ...
          >
            ...
            <div 
              className={`relative group/video rounded-2xl overflow-hidden bg-black/5 ${project.videoPortrait ? 'mx-auto max-w-[min(100%,320px)]' : 'w-full'}`}
              style={{
                aspectRatio: project.videoPortrait ? '9/16' : '16/9',
              }}
            >
              <video
                ref={videoRef}
            ...
            {/* Gallery - 16:9 boxes stacked vertically (untereinander) */}
              ...
              <div className="mt-6">
                ...
                <div className="grid grid-cols-1 gap-4">
                  {project.gallery.map((media, index) => (
                    <div 
                      key={index}
                      className={`relative aspect-video rounded-xl overflow-hidden bg-black/5 group ${media.type === 'image' ? 'cursor-pointer border border-[rgba(28,28,28,0.1)] hover:border-[rgba(28,28,28,0.25)] transition-colors' : ''}`}
